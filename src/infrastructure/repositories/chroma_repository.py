...
class ChromaRegulationRepository(IRegulationRepository):
    ...
    def get_by_type(self, regulation_type: str, limit: int = 10) -> List[Regulation]:
        ...
        try:
            results = self._collection.get(where={"type": regulation_type}, limit=limit)
    ...
    def get_applicable_to_location(
        ...
        try:
            ...
            results = self._collection.query(query_texts=[location], n_results=limit)
    ...
    def add_regulation(self, regulation: Regulation) -> bool:
        ...
        try:
            ...
            self._collection.add(
                documents=[document], metadatas=[metadata], ids=[regulation.id]
            )
