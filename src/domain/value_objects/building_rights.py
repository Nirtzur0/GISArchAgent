...
class BuildingRights:
    ...
    def get_available_building_area(
        self, existing_area: Decimal = Decimal("0")
    ) -> Decimal:
        """
    ...
    def get_available_coverage(
        self, existing_coverage: Decimal = Decimal("0")
    ) -> Decimal:
        """
...
class BuildingRightsCalculator:
    ...
    def calculate_from_zone(
        plot_size_sqm: Decimal, zone_type: str, location: str = ""
    ) -> BuildingRights:
        """
