...
3. Generate the routing plan:
   - `python3 <prompt_pack_dir>/scripts/prompt_router.py select --target-root . --phase auto --output docs/implementation/reports/prompt_execution_plan.md`
